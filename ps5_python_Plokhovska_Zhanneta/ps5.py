...
def main():
	...
	# Smooth images
	shift0 = cv2.GaussianBlur(shift0, (3, 3), 0)
	shiftr2 = cv2.GaussianBlur(shiftr2, (3, 3), 0)
	shiftr5u5 = cv2.GaussianBlur(shiftr5u5, (3, 3), 0)
	shiftr10 = cv2.GaussianBlur(shiftr10, (3, 3), 0)
	shiftr20 = cv2.GaussianBlur(shiftr20, (3, 3), 0)
	shiftr40 = cv2.GaussianBlur(shiftr40, (3, 3), 0)
	# Get image gradients
